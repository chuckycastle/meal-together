  ...
  return (
    <form onSubmit={handleSubmit(handlePasswordChange)} className="space-y-4">
      <div className="relative">
        <label htmlFor="current_password" className="block text-sm font-medium text-gray-800 dark:text-gray-300">
          Current Password
        </label>
        <input
        ...
        >
          <svg className="h-5 w-5 text-gray-800 dark:text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            {showCurrentPassword ? (
      ...
      <div className="relative">
        <label htmlFor="new_password" className="block text-sm font-medium text-gray-800 dark:text-gray-300">
          New Password
        </label>
        <input
      ...
      <div className="relative">
        <label htmlFor="confirm_password" className="block text-sm font-medium text-gray-800 dark:text-gray-300">
