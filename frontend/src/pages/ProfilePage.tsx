            ...
            <button
              ...
              className={`${
                activeTab === 'profile'
                  ...
                  : 'border-transparent text-gray-800 hover:text-gray-800 hover:border-gray-300 dark:text-gray-800 dark:hover:text-gray-300'
          ...
          {activeTab === 'families' && (
            <div>
              ...
              <div className="space-y-3">
                ...
                {families.length === 0 && (
                  <p className="text-center text-gray-800 dark:text-gray-800 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between py-2 border-b border-gray-200 dark:border-gray-700">
              <span className="text-sm text-gray-800 dark:text-gray-800">Account Status</span>
            ...
            <div className="flex items-center justify-between py-2 border-b border-gray-200 dark:border-gray-700">
              <span className="text-sm text-gray-800 dark:text-gray-800">Member Since</span>
              <span className="text-sm font-medium text-gray-900 dark:text-white">
                {new Date(user.created_at).toLocaleDateString()}
              </span>
            </div>
            <div className="flex items-center justify-between py-2">
              <span className="text-sm text-gray-800 dark:text-gray-800">Last Updated</span>
              <span className="text-sm font-medium text-gray-900 dark:text-white">
